...
exports.InternalAssetCatalog = void 0;
exports.isInternalRef = isInternalRef;
exports.parseInternalRef = parseInternalRef;
...
function parseInternalRef(value) {
...
class InternalAssetCatalog {
    _assets = new Map();
    _loaded = false;
    /** 从 Bridge 心跳加载（优先于内置回退） */
    loadFromBridge(bridgeAssets, _projectPath) {
...
exports.InternalAssetCatalog = InternalAssetCatalog;
//# sourceMappingURL=internal-catalog.js.map