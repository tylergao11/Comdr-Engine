...
import { AssemblyOptions, AssemblyResult, DslCommand, CmdResult, ExecutedCommand, CompileSpec, NoteEntry, ConsoleLogEntry, ExecutionEvent, ExecutionEventKind } from '../types';
...
import { SnapshotManager } from '../memory/undo-manager';
import { diffPrefab, PrefabDiffResult } from '../perception/prefab-diff';
import { resolveAssetValue, resolveAssetValues } from '../perception/asset-resolver';
import { callCommander } from './commander';
import { parseDslOutput } from '../dsl/parser';
import { formatCommandResults, formatChainFailure, buildTurnDelta } from '../dsl/formatter';
import { RefResolver } from '../model/cocos-world';
import { ComponentCatalog, createRefResolver } from '../model/component-catalog';
import { InternalAssetCatalog } from '../model/internal-catalog';
import { assemble, assembleSubtree } from '../translation/assembler';
import { generateSystemPrompt } from './prompt';
import { ERR_DSL_UNKNOWN_CMD, ERR_ASM_INVALID_SPEC, ERR_SCH_COMPONENT_NOT_FOUND, ERR_VAL_INVALID_ID_REF, ERR_INVALID_ARG, ERR_ASM_NO_COMPILED_JSON, ERR_GW_EXECUTION_ERROR, ERR_GW_UNRESOLVED_TEMPID } from '../errors/error-codes';
